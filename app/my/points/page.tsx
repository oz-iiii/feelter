    ...
    <MyLayout>
      <div className="w-full max-w-4xl mx-auto px-4 pb-8">
          ...
          <div className="bg-gray-800 rounded-lg p-6 shadow-sm">
            <div className="flex items-center">
              <div className="p-3 bg-[#404400] rounded-lg mr-4">
                <svg className="w-6 h-6 text-[#e6ff4d]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1" />
                </svg>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-white">현재 포인트</h3>
                <p className="text-2xl font-bold text-[#ccff00]">{currentPoints.toLocaleString()} P</p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-gray-800 rounded-lg shadow-sm p-6 mb-8">
          <h2 className="text-xl font-semibold text-white mb-4">포인트 적립 방법</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="border border-gray-700 rounded-lg p-4">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-medium text-white">영화 리뷰 작성</h3>
                  <p className="text-sm text-gray-400">상세한 리뷰를 작성하세요</p>
                </div>
            ...
            <div className="border border-gray-700 rounded-lg p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-400">시청한 영화에 평점을 주세요</p>
                </div>
            ...
            <div className="border border-gray-700 rounded-lg p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-400">다른 사용자에게 영화 추천</p>
                </div>
            ...
            <div className="border border-gray-700 rounded-lg p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-400">매일 로그인하면 적립됩니다</p>
                </div>
