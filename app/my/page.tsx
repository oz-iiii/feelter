...
export default function MyPage() {
  ...
  const [watchHistory] = useState([
    { id: 1, title: "인터스텔라", poster: "/among-us-poster.png", watchDate: "2024.08.10", rating: 4.5 },
    { id: 2, title: "기생충", poster: "/among-us-poster.png", watchDate: "2024.08.08", rating: 5.0 },
    { id: 3, title: "타이타닉", poster: "/among-us-poster.png", watchDate: "2024.08.05", rating: 4.0 }
  ]);

  const [favorites] = useState([
    { id: 1, title: "인셉션", poster: "/among-us-poster.png", year: 2010, genre: "SF/스릴러" },
    { id: 2, title: "라라랜드", poster: "/among-us-poster.png", year: 2016, genre: "뮤지컬/로맨스" },
    { id: 3, title: "어벤져스", poster: "/among-us-poster.png", year: 2012, genre: "액션/어드벤처" }
  ]);
