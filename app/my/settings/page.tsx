    ...
    <MyLayout>
      <div className="w-full max-w-4xl mx-auto px-4 pb-8">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-gray-800 rounded-lg shadow-sm p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-sm font-medium text-white">이메일 알림</h3>
                  <p className="text-sm text-gray-400">새로운 소식을 이메일로 받아보세요</p>
                </div>
                <button
                  onClick={() => updateSetting('notifications', 'email', !settings.notifications.email)}
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                    settings.notifications.email ? 'bg-[#ccff00]' : 'bg-gray-700'
                  }`}
                >
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-400">실시간 푸시 알림을 받아보세요</p>
                </div>
                <button
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-400">맞춤형 영화 추천을 받아보세요</p>
                </div>
                <button
                  onClick={() => updateSetting('notifications', 'movieRecommendations', !settings.notifications.movieRecommendations)}
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                    settings.notifications.movieRecommendations ? 'bg-[#ccff00]' : 'bg-gray-700'
                  }`}
                >
                  <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-400">내 리뷰에 댓글이 달릴 때 알림을 받습니다</p>
                </div>
                <button
                  onClick={() => updateSetting('notifications', 'reviewComments', !settings.notifications.reviewComments)}
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                    settings.notifications.reviewComments ? 'bg-[#ccff00]' : 'bg-gray-700'
                  }`}
                >
                  <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-400">새로운 영화 출시 소식을 받아보세요</p>
                </div>
                <button
                  onClick={() => updateSetting('notifications', 'newReleases', !settings.notifications.newReleases)}
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                    settings.notifications.newReleases ? 'bg-[#ccff00]' : 'bg-gray-700'
                  }`}
                >
                  <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
          ...
          {/* Privacy Settings */}
          <div className="bg-gray-800 rounded-lg shadow-sm p-6">
            <h2 className="text-xl font-semibold text-white mb-6">개인정보 설정</h2>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-sm font-medium text-white">시청 이력 공개</h3>
                  <p className="text-sm text-gray-400">다른 사용자가 내 시청 이력을 볼 수 있습니다</p>
                </div>
                <button
                  onClick={() => updateSetting('privacy', 'showWatchHistory', !settings.privacy.showWatchHistory)}
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                    settings.privacy.showWatchHistory ? 'bg-[#ccff00]' : 'bg-gray-700'
                  }`}
                >
                  <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-sm font-medium text-white">즐겨찾기 공개</h3>
                  <p className="text-sm text-gray-400">다른 사용자가 내 즐겨찾기 목록을 볼 수 있습니다</p>
                </div>
                <button
                  onClick={() => updateSetting('privacy', 'showFavorites', !settings.privacy.showFavorites)}
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                    settings.privacy.showFavorites ? 'bg-[#ccff00]' : 'bg-gray-700'
                  }`}
                >
                  <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-400">시청 기록을 기반으로 맞춤형 추천을 받습니다</p>
                </div>
                <button
                  onClick={() => updateSetting('privacy', 'allowRecommendations', !settings.privacy.allowRecommendations)}
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                    settings.privacy.allowRecommendations ? 'bg-[#ccff00]' : 'bg-gray-700'
                  }`}
                >
                  <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
          ...
          <div className="bg-gray-800 rounded-lg shadow-sm p-6">
            ...
            <div className="space-y-4">
              <button className="w-full text-left px-4 py-3 border border-gray-600 rounded-lg hover:bg-gray-700 transition-colors">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-sm font-medium text-white">비밀번호 변경</h3>
                    <p className="text-sm text-gray-400">계정 보안을 위해 주기적으로 변경해주세요</p>
                  </div>
